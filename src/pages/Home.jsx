...
// --- Reusable pieces, declared once at module scope so React never recreates them ---
...
const CTAButtons = ({ onViewWork, onGetInTouch }) => (
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-20 lg:py-0 w-full">
        ...
        {/* Order: Headline + Description -> Photo -> Availability badge -> CTAs -> Social -> Tech stack */}
        <div className="lg:hidden flex flex-col items-center text-center gap-8 relative z-10">
